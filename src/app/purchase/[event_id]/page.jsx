...
export default function PurchaseTicketPage({params}) {
    ...
    return (
        <Flex direction="column" align="center" h="100vh">
            ...
            <Text mt="1rem" fontSize="2rem" fontWeight="semibold">Event info</Text>
            ...
            <Stack>
                <Text mt="1rem" fontSize="2rem" fontWeight="semibold">Purchase tickets</Text>
                ...
                <Button onClick={() => {router.push(`/ticket-marketplace/${event.id}`)}} colorScheme="primary">View Secondhand Tickets</Button>
            </Stack>
            </Stack>
        </Flex>
    );
